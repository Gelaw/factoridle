...
local Recipe = {}
  ...
  {id = 3, machineSubtypeData = "player", intrants = {{itemID = 3, quantity = 5}}, extrants = {{itemID = 9, quantity = 1}}, time = 5},
  {id = 4, machineSubtypeData = "player", intrants = {{itemID = 2, quantity = 2}, {itemID = 3, quantity = 1}}, extrants = {{itemID = 10, quantity = 1}}, time = 5}}
